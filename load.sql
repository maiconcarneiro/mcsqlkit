/*
 Script to generate a matrix with the DB Node CPU Load Average (captured by AWR)
 Syntax: SQL>@load <Qtd. Days> <Inst ID> (Where Inst ID = 0 sums all instances in the cluster)
