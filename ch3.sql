/*
 Script to list the TOP Wait Events of a SQL ID via AWR-ASH
 Example: @ch3 <SQL_ID>  <DAYS>

 2022 - Shared by Marcelo Favero (@enkitec)
 2023 - Maicon Carneiro: Adjusted the script to list one event per line instead of separated by comma.
*/
