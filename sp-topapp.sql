...
col app_wait_time heading "App Wait Time (secs)" format 999,999,999.99
col app_wait_time_avg heading "App Wait Time avg" format 999,999,999.99
...
select 
   sql_id,
     ...
     round(app_wait_time,4) as app_wait_time,
	 round(app_wait_time/executions,4) as app_wait_time_avg
...
from (
	select h.sql_id,     
           ...
           sum(application_wait_time_delta)/1e6 as app_wait_time
