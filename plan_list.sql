...
where 1=1
and signature in (select exact_matching_signature from gv$sql where sql_id='&1')
...
FROM DBA_SQL_PROFILES P
 where signature in (select exact_matching_signature from gv$sql where sql_id='&1')
