...
SELECT TRUNC(begin_snap) snap_date,
 max (DECODE (hora, '00', avg_time_ms, null)) "h0",
 max (DECODE (hora, '01', avg_time_ms, null)) "h1",
 max (DECODE (hora, '02', avg_time_ms, null)) "h2",
 max (DECODE (hora, '03', avg_time_ms, null)) "h3",
 max (DECODE (hora, '04', avg_time_ms, null)) "h4",
 max (DECODE (hora, '05', avg_time_ms, null)) "h5",
 max (DECODE (hora, '06', avg_time_ms, null)) "h6",
 max (DECODE (hora, '07', avg_time_ms, null)) "h7",
 max (DECODE (hora, '08', avg_time_ms, null)) "h8",
 max (DECODE (hora, '09', avg_time_ms, null)) "h9",
 max (DECODE (hora, '10', avg_time_ms, null)) "h10",
 max (DECODE (hora, '11', avg_time_ms, null)) "h11",
 max (DECODE (hora, '12', avg_time_ms, null)) "h12",
 max (DECODE (hora, '13', avg_time_ms, null)) "h13",
 max (DECODE (hora, '14', avg_time_ms, null)) "h14",
 max (DECODE (hora, '15', avg_time_ms, null)) "h15",
 max (DECODE (hora, '16', avg_time_ms, null)) "h16",
 max (DECODE (hora, '17', avg_time_ms, null)) "h17",
 max (DECODE (hora, '18', avg_time_ms, null)) "h18",
 max (DECODE (hora, '19', avg_time_ms, null)) "h19",
 max (DECODE (hora, '20', avg_time_ms, null)) "h20",
 max (DECODE (hora, '21', avg_time_ms, null)) "h21",
 max (DECODE (hora, '22', avg_time_ms, null)) "h22",
 max (DECODE (hora, '23', avg_time_ms, null)) "h23"
FROM awr
