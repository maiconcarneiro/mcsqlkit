/*
 Script to generate a matrix with the event waits count per hour
 Syntax: SQL>@waits '<event name>' <days> <inst_id> 
 
 Maicon Carneiro | Salvador-BA, 2022-11-10
*/
...
-- report summary
PROMP
PROMP Metric....: Wait Event count per hour
PROMP Event.....: &1
PROMP Qt. Days..: &2
...
PROMP Values are displayed in multiple of 1.000 (Example: 10 = 10.000 / 100 = 100.000 / 1.000 = 1.000.000)
PROMP
